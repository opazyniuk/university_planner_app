class DisciplinesController < ApplicationController
  ...
  def student_disciplines
    @disciplines = Discipline.find_by(discipline_type: 'for_choose')
  end

  def set_student_disciplines
    current_user.shedule.disciplines.add(params[:discipline_id])
  end

  def group_disciplines
    @disciplines = Discipline.find_by(group)
  end
  ...
  private
    ...
    def discipline_params
      params.require(:discipline).permit(:name, :credits)
    end
end
